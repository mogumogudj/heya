                                ...
                                <div className='room__info__main-content'>
                                    ...
                                    <div className='room__transactions'>
                                        ...
                                        <div className='transactions__list'>
                                            <TransactionCard transactionAmount="€32,50" transactionDate="June 2024" transactionTime="2:42 PM" transactionUser="Tjerk Symens" cardType="big" />
                                            <TransactionCard transactionAmount="€34,50" transactionDate="May 2024" transactionTime="1:33 PM" transactionUser="Wolf Ver Elst" cardType="big" />
                                        </div>
                ...
                <div className="page__container">
                    ...
                    <div className="content">
                        ...
                        <p>
                            ...
                            Please make sure your account is setup correctly on your <a className='underline' href="profile">profile page</a> <br />
                            If the error still proceeds <a className='underline' href="contact">contact us</a>.
                        </p>
                    </div>
                    <Footer />
                </div>

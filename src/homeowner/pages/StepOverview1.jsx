...
function StepOverview1() {
    ...
    return (
        ...
        <div className="page__container" style={{height: '100%'}}>
          ...
          description="Please fill out the form below with your personal details. This information is crucial for us to create your homeowner profile and ensure that we have all the necessary data to support your hospitawonen journey. All information provided will be kept confidential and secure."

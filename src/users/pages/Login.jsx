                    ...
                    <div className="page__container__login">
                        ...
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <button className="google__button">
                                <GoogleIcon fontSize="small" /> Create with Google
                            </button>
                            <button className="facebook__button">
                                <FacebookRoundedIcon fontSize="small" /> Create with Facebook
                            </button>
                            ...
                            <button onClick={handleCreateAccount} className="white__button big">
                                Create an account
                            </button>
                        </form>
                    </div>

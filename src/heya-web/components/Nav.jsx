...
function Nav() {
    ...
    return (
        <nav className="nav">
            <Link
                to="/home"
                className={`nav__box nav__box__home no-hover ${location.pathname === '/home' ? 'active' : ''}`}
            >
            ...
            <Link to="/blogs" className={`nav__box nav__box__faq ${location.pathname === '/blogs' ? 'active' : ''}`}>
                <div className="nav__img-wrapper hidden__desktop">
                    <MenuBookRoundedIcon
                        className={`do-not-show-on-desktop ${location.pathname === '/blogs' ? 'active-icon' : ''}`}
                    />
                </div>
                <span>Blogs</span>
            </Link>
            ...
            <Link to="/about" className={`nav__box nav__box__about ${location.pathname === '/about' ? 'active' : ''}`}>
                <div className="nav__img-wrapper hidden__desktop">
                    <InfoRoundedIcon
                        className={`do-not-show-on-desktop ${location.pathname === '/about' ? 'active-icon' : ''}`}
                    />
                </div>
                <span>About Us</span>
            </Link>
            ...
            <Link to="/faq" className={`nav__box nav__box__faq ${location.pathname === '/faq' ? 'active' : ''}`}>
                <div className="nav__img-wrapper hidden__desktop">
                    <QuizRoundedIcon
                        className={`do-not-show-on-desktop ${location.pathname === '/faq' ? 'active-icon' : ''}`}
                    />
                </div>
                <span>FAQ</span>
            </Link>
            ...
            <Link
                to="/contact"
                className={`nav__box nav__box__contact ${location.pathname === '/contact' ? 'active' : ''}`}
            >
                <div className="nav__img-wrapper hidden__desktop">
                    <ContactSupportRoundedIcon
                        className={`do-not-show-on-desktop ${location.pathname === '/contact' ? 'active-icon' : ''}`}
                    />
                </div>
                <span>Contact</span>
            </Link>

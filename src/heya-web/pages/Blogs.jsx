        ...
        <div className="page__container">
            ...
            <div className="content">
                ...
                <Article
                        ...
                        imageUrl="public/Blogs/medium-shot-people-planning-trip-indoors.webp"
                        className="article"
                    />
                    <Article
                        type="Default"
                        ...
                        imageUrl="public/Blogs/gents-schepen-van-wonen-tine-heyse-groen-het-heeft-financiele.webp"
                        className="article"
                    />
                </div>
                <CitySelector />
                ...
                <Article
                        ...
                        imageUrl="public/Blogs/medium-shot-man-grandchild-with-laptop.webp"
                        className="article"
                    />
                    <Article
                        type="Default"
                        ...
                        imageUrl="public/Blogs/low-angle-view-building-with-windows-against-blue-sky-duotone.webp"
                        className="article"
                    />
                    <Article
                        type="Default"
                        ...
                        imageUrl="public/Blogs/hospitawonen.webp"
                        className="article"
                    />
                </div>
            </div>
